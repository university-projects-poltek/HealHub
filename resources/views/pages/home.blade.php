...
<section id="header" class="h-[400px]">
  ...
  <div class="container max-w-[1130px] mx-auto flex flex-col items-center justify-center gap-[34px] z-10">
    <div class="z-10 flex flex-col gap-2 mt-20 text-center w-fit">
      <h1 class="font-semibold text-white w-[1312px] text-[48px] leading-[62px]">Kami Peduli Dengan Kesehatan Anda</h1>
      <p class="text-lg text-[#DEDEDE] leading-[27px]">Jelajahi beragam produk farmasi, suplemen, dan produk perawatan
